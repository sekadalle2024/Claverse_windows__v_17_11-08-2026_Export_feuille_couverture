            ...
            tests: [
              {
                id: 'stocks-cc020',
                reference: 'CC020',
                label: 'Test sur la centralisation',
                processus: 'Stock',
                command: `[Command] = /feuille couverture
[Processus] = Stock
[test] = CC020
...
[Nb de lignes] = 10`
              ...
              },
              {
                id: 'stocks-cc025',
                reference: 'CC025',
                label: 'Test Stock Phys_Théorique',
                processus: 'Stock',
                command: `[Command] = /feuille couverture
[Processus] = Stock
[test] = CC025
...
[Nb de lignes] = 10`
              ...
              },
              {
                id: 'stocks-cc030',
                reference: 'CC030',
                label: 'Test Stock Physi_Inventorié',
                processus: 'Stock',
                command: `[Command] = /feuille couverture
[Processus] = Stock
[test] = CC030
...
[Nb de lignes] = 10`
              ...
              },
              {
                id: 'stocks-cc040',
                reference: 'CC040',
                label: 'Rapprochement de solde BG AAchier stock',
                processus: 'Stock',
                command: `[Command] = /feuille couverture
[Processus] = Stock
[test] = CC040
...
[Nb de lignes] = 10`
              ...
              },
              {
                id: 'stocks-cc120',
                reference: 'CC120',
                label: 'Rapprochement de solde Valorisation',
                processus: 'Stock',
                command: `[Command] = /feuille couverture
[Processus] = Stock
[test] = CC120
...
[Nb de lignes] = 10`
              ...
              },
              {
                id: 'stocks-cc145',
                reference: 'CC145',
                label: 'Valorisation en CUMP AAN',
                processus: 'Stock',
                command: `[Command] = /feuille couverture
[Processus] = Stock
[test] = CC145
            ...
            tests: [
              {
                ...
                reference: 'DD040',
                label: 'Tableau Mouv immobilisations',
                processus: 'IMMOBILISATIONS',
                command: `[Command] = /feuille couverture
[Processus] = IMMOBILISATIONS
[test] = DD040
...
[Nb de lignes] = 10`
              ...
              },
              {
                ...
                reference: 'DD045',
                label: 'Rapprochement de solde BG AAchier immob',
                processus: 'IMMOBILISATIONS',
                command: `[Command] = /feuille couverture
[Processus] = IMMOBILISATIONS
[test] = DD045
...
[Nb de lignes] = 10`
              ...
              },
              {
                ...
                reference: 'DD145',
                label: 'Test dotation aux amortissements',
                processus: 'IMMOBILISATIONS',
                command: `[Command] = /feuille couverture
[Processus] = IMMOBILISATIONS
[test] = DD145
...
[Nb de lignes] = 10`
              ...
              },
              {
                id: 'clients-fe300',
                reference: 'FE300',
                label: 'Test de séparation des exercices Client',
                processus: 'client',
                command: `[Command] = /feuille couverture
[Processus] = client
[test] = FE300
...
[Nb de lignes] = 10`
              ...
              },
              {
                id: 'clients-fe340',
                reference: 'FE340',
                label: 'Test de séparation des exercices Avoirs',
                processus: 'client',
                command: `[Command] = /feuille couverture
[Processus] = client
[test] = FE340
            ...
            tests: [
              {
                ...
                reference: 'FF040',
                label: 'Circularisation fournisseurs',
                processus: 'fournisseur',
                command: `[Command] = /feuille couverture
[Processus] = fournisseur
[test] = FF040
...
[Nb de lignes] = 10`
              ...
              },
              {
                ...
                reference: 'FF045',
                label: 'Rapprochement de solde BA-BG',
                processus: 'fournisseur',
                command: `[Command] = /feuille couverture
[Processus] = fournisseur
[test] = FF045
...
[Nb de lignes] = 10`
              ...
              },
              {
                ...
                reference: 'FF200',
                label: 'Procédure alternative FRS',
                processus: 'fournisseur',
                command: `[Command] = /feuille couverture
[Processus] = fournisseur
[test] = FF200
...
[Nb de lignes] = 10`
              ...
              },
              {
                ...
                reference: 'FF300',
                label: 'Test de séparation des exercices Fournisseurs',
                processus: 'fournisseur',
                command: `[Command] = /feuille couverture
[Processus] = fournisseur
[test] = FF300
...
[Nb de lignes] = 10`
              ...
              },
              {
                ...
                reference: 'FF445',
                label: 'Test charges récurrentes',
                processus: 'fournisseur',
                command: `[Command] = /feuille couverture
[Processus] = fournisseur
[test] = FF445
            ...
            tests: [
              {
                id: 'personnel-fp040',
                reference: 'FP040',
                label: 'Test CotisationsFiscales',
                processus: 'personnel',
                command: `[Command] = /feuille couverture
[Processus] = personnel
[test] = FP040
...
[Nb de lignes] = 10`
              ...
              },
              {
                id: 'personnel-fp045',
                reference: 'FP045',
                label: 'Rapprochement de solde BG-livre de paie',
                processus: 'personnel',
                command: `[Command] = /feuille couverture
[Processus] = personnel
[test] = FP045
...
[Nb de lignes] = 10`
              ...
              },
              {
                id: 'personnel-fp130',
                reference: 'FP130',
                label: 'Validation base imposable',
                processus: 'personnel',
                command: `[Command] = /feuille couverture
[Processus] = personnel
[test] = FP130
            ...
            tests: [
              {
                id: 'impots-nn040',
                reference: 'NN040',
                label: 'Rapprochement de solde TVA - CA',
                processus: 'impôt et taxes',
                command: `[Command] = /feuille couverture
[Processus] = impôt et taxes
[test] = NN040
...
const getModeIcon = (modeId: string) => {
  switch (modeId) {
    ...
    case 'papier-travail': return <FileText className="w-4 h-4" />;
    default: return null;
  }
};
